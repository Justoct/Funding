package com.hualxx.crowd.constant;

/**
 * @author hual
 * @create 2020-11-12 3:18
 */
public class CrowdConstant {
    ...
    public static final String MESSAGE_HEADER_PIC_EMPTY = "头图不可空！";
    ...
    public static final String ATTR_PORTAL_DATA = "portal_data";

    public static final String ATTR_CODE_PREFIX = "REDIS_CODE_PREFIX_";
}
