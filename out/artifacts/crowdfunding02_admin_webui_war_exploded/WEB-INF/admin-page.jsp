...
<script type="text/javascript">
    ...
    function initPagination() {
        ...
        var properties = {
            ...
            current_page:${requestScope.pageInfo.pageNum-1},    //Pageination内部使用pageIndex来管理页码，pageIndex从0开始，pageNUm从1开始，所以减一
        ...
        function pageSelectCallback(pageIndex,jQuery) {
            ...
            //由于每一个页码按钮都是超链接，所以在这个函数最后取消超链接的默认行为（跳转）
            return false;
        }
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form   action="/admin/get/page.html"
                            method="post"
                            class="form-inline"
                            role="form"
                            style="float:left;">
                    ...
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <c:if test="${empty requestScope.pageInfo.list}">
                                <tr>
                                    <td colspan="6" align="center">抱歉！没有您要的数据！</td>
                                </tr>
                            </c:if>
                                ...
                                <c:forEach items="${requestScope.pageInfo.list}" var="admin" varStatus="mystatus">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="admin/remove.html/${admin.id}/${requestScope.pageInfo.pageNum}/${param.keyword}.html"
